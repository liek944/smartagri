...
import { Receipt, Package, Store, ShoppingBag } from 'lucide-react';
...
export default function OrdersPage({ orders, currentUser, onViewReceipt, onGoShopping }: OrdersPageProps) {
      ...
      {displayOrders.length === 0 ? (
        ...
        <div className="space-y-6">
          {displayOrders.map((order) => {
            ...
            const displayItems = isSale ? order.items.filter(i => i.producerId === currentUser.id) : order.items;
